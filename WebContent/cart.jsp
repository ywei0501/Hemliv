...
<html>
	<head>
		...
		<script type="text/javascript">
			function delProFromCart(proId){
				if(confirm("您是否要删除该项？")){
					location.href="${pageContext.request.contextPath }/product?method=delProFromCart&proId="+proId;
				}
			}
								...
								<c:forEach items="${cart.cartItems }" var="entry">
									...
									<tr class="active">
										<td width="60" width="40%">
											...
											<img src="${pageContext.request.contextPath }/${entry.value.product.proImage}" width="70" height="60">
										</td>
										<td width="30%">
											<a target="_blank">${entry.value.product.proName}</a>
										</td>
										<td width="20%">
											￥${entry.value.product.proPrice}
										</td>
										<td width="10%">
											${entry.value.buyNum }
										</td>
										...
										<td>
											<a href="javascript:;" onclick="delProFromCart('${entry.value.product.proId}')" class="delete">删除</a>
										</td>
									</tr>
