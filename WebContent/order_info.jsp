						...
						<c:forEach items="${order.orderItems }" var="orderItem">
							...
							<tr class="active">
								<td width="60" width="40%">
									<img src="${pageContext.request.contextPath }/${orderItem.product.proImage}" width="70" height="60">
								</td>
								<td width="30%"><a target="_blank">${orderItem.product.proName}</a></td>
								<td width="20%">￥${orderItem.product.proPrice}</td>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputPassword3" name="name"
							placeholder="请输收货人" value="${memberinfo.memUserName }">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="confirmpwd" name="telephone"
							placeholder="请输入联系方式"  value="${memberinfo.memMoblieP }">
					</div>
				</div>
