...
<script type="text/javascript">
	function addCart(){
		...
		location.href="${pageContext.request.contextPath}/product?method=addProductToCart&proId=${product.proId}&buyNum="+buyNum;
	}
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div>编号：${product.proId}</div>
					</div>

					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${product.proPrice}元/份</strong> 参 考 价：
						<del>￥${product.proPrice}元/份</del>
					</div>
					...
					<div>
						<a href="${pageContext.request.contextPath}/product?method=productList&ProSid=${proSid }&currentPage=${currentPage}">返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
