...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010201','0102','分类管理','${pageContext.request.contextPath}/admin?method=productsortList','','mainFrame');
		d.add('0104','01','商品管理');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/admin?method=productList','','mainFrame');
		d.add('0105','01','人事管理');
		d.add('010501','0105','人事管理','${pageContext.request.contextPath}/admin?method=memberinfoList','','mainFrame');
		d.add('0106','01','订单管理');
